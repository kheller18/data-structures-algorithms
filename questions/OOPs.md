...
1. What are some major Object Oriented Programming languages?
...
1. What are some advantages of using OOPs?
...
1.  What is a class?
+ Class: can be understood as a template or a blueprint, which contains some values, known as member data or member, and some set of rules, known as behaviors or functions. So when an object is created, it automatically takes the data and functions that are defined in the class.
...
1.  What is an object?
+ Object: refers to the instance of the class, which contains the instance of the members and behaviors defined in the class template. In the real world, an object is an actual entity to which a user interacts, whereas class is just the blueprint for that object. So the objects consume space and have some characteristic behavior.
...
1.  What is Compile time Polymorphism and how is it different from Runtime Polymorphism?
...
1.  How does C++ support Polymorphism?
...
1.  What are the various types of constructors in C++?
...
1.  Are class and structure the same? If not, what's the difference between a class and a structure?
...
1.  Are there any limitations of inheritance?
...
1.  What are the various types of inheritance?
+ Single inheritance
...
+ Subclass: is a part of Inheritance. The subclass is an entity, which inherits from another class. It is also known as the child class.
...
1.  What is meant by static polymorphism?
...
1.  How is data abstraction accomplished?
...
1.  What is meant by exception handling?
...
1.  What is meant by Garbage Collection in OOPs world?
...
1.  Can we run a Java application without implementing the OOPs concept?
