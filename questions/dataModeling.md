...
1. What is a data model? What are its types?
...
1. What do you understand by dimension in data?
...
1. What do you mean by data sparsity?
...
+ Online Transaction Processing (OLTP): an operational system supporting transaction-oriented applications in 3-tier architecture. It focuses on query processing, data integrity maintenance, transaction effectiveness per second in multi-access environments.
...
1.  What is On-Line Analytical Processing (OLAP)?
...
+ Data Mart: is a condensed data warehouse version (a subset of a data warehouse) designed for a specific unit or a department like Marketing, Sales, HR, finance etc in an organization. There can be different data marts specific to individual departments which can interact with the data warehouse for information processing as shown in the image below:
  ![data mart](../images/data-modeling/data_mart.png)

1.  What is the significance of metadata?
...
+ Relational database: is a digital database system that is based on a relational data model and is useful for storing data in tables. Oracle, Teradata, MySQL, PostgreSQL, SQLite etc are types of relational databases. The data is transformed into rows and columns which is standardized and can be queried with SQL. RDBMS helps to add/ alter tables and column data into the database systematically by maintaining data integrity.
...
2.  How is SQL different from NoSQL?
  ![sql vs nosql](../images/data-modeling/sql_nosql.png)

3.  What will happen if we try inserting two nulls in a column having a unique constraint on it?
...
1.  What are the phases in the data modeling development cycle?
...
2.  What do you understand by Star schema?
...
1.  Explain snowflake schema database design.
+ Snowflake schema: is a schema that has one or more dimension tables that do not connect directly to the fact table but should be interacting with it via other dimension tables.
...
1.  What are the critical relationship types in a Data Model?
...
1.  What are the types of visual data modeling techniques?
...
1.  How can you relate CAP Theorem to database design?
...
1.  What Are Recursive Relationships?
...
1.  What are the types of dimensions in data modeling?
...
1.  How can you perform reverse engineering in data modeling?
+ 

1.  What is the importance of the third normal form?
+ 

1.  What are some of the common mistakes encountered in data modeling?
+ 
