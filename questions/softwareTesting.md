...
1. Is Automation testing in agile methodology useful?
...
1. State the difference between bugs and errors
...
1. What is a Test Report? What does it include?
...
1. What do you mean by Test Deliverables?
...
1. What are different categories of debugging?
...
1. What is defects in software testing?
...
1. What is Software Process Improvement and Capability Determination (SPICE) in software testing?
...
1. What is the purpose of TestNG?
...
1. What is the best way to set priority for test cases in TestNG?
...
1. Explain Boundary Value Analysis (BVA) in software testing.
...
1. How much testing is sufficient? Or, is it possible to do exhaustive testing of the software?
...
2. What is Software Development Life Cycle (SDLC) in software testing?
...
1. What are some important testing metrics?
...
1. What is Selenium? What are its benefits?
...
1. What are the various components of Selenium?
...
1. What are the different HTTP status codes that a server can return?
...
1. What is the most effective way to map automation testing success?
...
1. What are the different types of severity you can assign to a bug?
...
1. State difference between verification and validation in software testing.
...
1. What is static software testing?
...
1. What is dynamic software testing?
...
1. When there is neither a frame ID nor a frame name, what technique should be considered in the script?
...
1. How can Selenium WebDriver be used to detect broken links?
