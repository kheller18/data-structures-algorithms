...
1.  Explain passed by value and passed by reference.
...
1.  What is recursion in a programming language?
...
1.  What do you mean by BOM?
+ Browser Object Model is known as BOM. It allows users to interact with the browser. A browser's initial object is a window. As a result, you may call all of the window's functions directly or by referencing the window. The document, history, screen, navigator, location, and other attributes are available in the window object.



1.  What is the distinction between client-side and server-side JavaScript?
...
1.  What do mean by prototype design pattern?
...
1.  In JavaScript, how many different methods can you make an object?
...
1.  Difference between prototypal and classical inheritance?
...
1.  What do you mean by JavaScript Design Patterns?
...
1.  What has to be done in order to put Lexical Scoping into practice?
...
1.  What is the purpose of the following JavaScript code?
    ```
...
3.  Guess the outputs of the following code:
    ```
    // Code 1:
...
2.  Write the code given If two strings are anagrams of one another, then return true.
    ```
...
6.  Mention some popular features of ES6.
...
1.  What are the object oriented features supported in ES6.
...
1.  Give a thorough comparison between ES5 and ES6.
+ image
...
1.  When should one not use arrow functions?
...
1.  Explain the Rest parameter in ES6.
...
1.  Discuss the template literals in ES6.
...
1.  Why should one use ES6 classes?
...
1.  How can you create a class in ES6?
...
1.  What do you understand about default parameters?
...
1.  What do you understand about IIFE (Immediately Invoked Function Expressions)?
...
1.  What are the states of Promises in ES6?
...
1.  What is Export Default and Named Export in ES6?
...
1.  Which keyword can be used to deploy inheritance in ES6?
...
1.  What is the reason behind adding Symbol to ES6?
...
1.  Name some array methods that were introduced in ES6.
+ image
...
1.  How do you use Destructuring Assignment to swap variables?
    ```
    var a = 1, b = 2;
...
2.  What is the result of the spread operator array shown below?
+ `[...'apple']`
+ Output: ['a', 'p', 'p', 'l', 'e']
...
1.  What is a WeakMap in ES6? How is it different from a Map?
...
1.  What is the advantage of using the arrow syntax for a constructor method?
...
1.   What is the difference between Set and WeakSet in ES6?
...
1.   What is the difference between const and Object.freeze()?
...
1.   Why does the following not work as an IIFE (Immediately Invoked Function Expressions) ? What needs to be modified in order for it to be classified as an IIFE?
+ `function f(){ }();`
...
1.   Explain Internationalization and Localization.
