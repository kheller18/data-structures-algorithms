...
1. What do you understand by the best case, worst case and average case scenario of an algorithm?
...
1. What do you understand by the Asymptotic Notations?
...
1. Write an algorithm to swap two given numbers in Java without using a temporary variable.
...
1. Explain the Divide and Conquer Algorithmic Paradigm. Also list a few algorithms which use this paradigm.
...
1. What do you understand about Greedy algorithms? List a few examples of greedy algorithms.
...
1. What do you understand by a searching algorithm? List a few types of searching algorithms.
...
1. Describe the Linear Search Algorithm.
...
1. Describe the Binary Search Algorithm.
...
1. Write down an algorithm for adding a node to a linked list sorted in ascending order(maintaining the sorting property).
...
1. Write an algorithm for counting the number of leaf nodes in a binary tree.
...
1. What do you understand about the Dynamic Programming (DP) Algorithmic Paradigm? List a few problems which can be solved using the same.
...
1. Write down a string reversal algorithm. If the given string is "kitiR," for example, the output should be "Ritik".
+ Step 1: Start.
...
1. What do you understand about the Breadth First Search (BFS) algorithm.
...
1. What do you understand about the Depth First Search (DFS) algorithm.
...
1. What are few of the most widely used cryptographic algorithms?
+ IDEA
+ CAST
+ CMEA
+ 3-way
...
1. Describe the merge sort algorithm.
...
1. Describe the quick sort algorithm.
...
1. Describe the bubble sort algorithm with the help of an example.
...
1. Write an algorithm to find the maximum subarray sum for a given array. In other words, find the maximum sum that can be achieved by taking contiguous elements from a given array of integers.
...
1. Explain the Dijkstra's Algorithm to find the shortest path between a given node in a graph to any other node in the graph.
...
1. Can we use the binary search algorithm for linked lists? Justify your answer.
...
1. What are recursive algorithms? State the important rules which every recursive algorithm must follow.
...
1. Devise an algorithm to insert a node in a Binary Search Tree.
...
1. Define insertion sort and selection sort.
...
1. Define tree traversal and list some of the algorithms to traverse a binary tree.
...
1. Describe the heap sort algorithm.
...
1. What is the space complexity of the insertion sort algorithm?
...
1. What is the space complexity of the selection sort algorithm?
