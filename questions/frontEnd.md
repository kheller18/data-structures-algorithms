...
19. What is Mixin?
    + `Mixin`: is a code block that lets the group of CSS declarations which we can reuse in our site.
...
1.  What are the advantages of REST web services?
...
4.   What is the distinction between Class and Prototypal inheritance in Javascript?
...
5.   Tell me when and why should I make use of Webpack?
...
7.   How does the server hanger the page in which content is present in several languages?
...
8.   Why did we utilize the data - the attribute in HTML and why it is now advised not to use?
...
9.   What are the benefits of CoffeeScript over JavaScript?
...
11.  What is the the Anonymous function in JS?
...
12.  What are some ways on how to fix the browser-specific styling issues?
...
13.  What are the pitfalls for using a CSS Preprocessor like Syntactically Awesome Style Sheets (Sass)?
...
14.  How can we optimize our front-end page.
...
17.  What the major HTTP requests?
![http methods](../images/front-end/http_requests.png)
![http status codes](../images/front-end/status_codes.png)

1.   What do you know about the CSS image sprites and why it is utilized?
...
6.  What is the difference between a PWA and a regular app?
...
9.  Why and when should I Use Babel and Webpack?
...
12. What is difference between apply, call and bind?
...
17. What is a CDN and what is the benefit of using CDN?
...
19. What is the difference between a unit test and a functional test?
